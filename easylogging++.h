           ...
           // Subtract the difference
            ...
            tv->tv_usec = static_cast<long>(present % usecOffSet);
                ...
                static inline std::string getDateTime(const char *format, const base::MillisecondsWidth *msWidth)
                {
                    ...
                    parseFormat(buff_, kBuffSize, format, &timeInfo, static_cast<std::size_t>(currTime.tv_usec /
                                                                                              msWidth->m_offset), msWidth);
                        ...
                        if (*format == base::consts::kFormatSpecifierChar)
                        {
                            switch (*++format)
                            {
                                ...
                                case 'g':
                                    ...
                                    continue;
                                case 'F':  // AM/PM
                                    buf = base::utils::Str::addToBuff((tInfo->tm_hour >= 12) ? base::consts::kPm
...
/// @brief Implements IterableContainer and provides iterable std::priority_queue class
            ...
            class IterablePriorityQueue
                    : public IterableContainer<T, Container>, public std::priority_queue<T, Container, Comparator>
            {
            public:
